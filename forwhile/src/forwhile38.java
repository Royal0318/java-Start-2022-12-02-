...
public class forwhile38 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 14; i++) {
            ...
            if (Count == 3) {
                while (true) {
                    System.out.println("어떤 음식을 환불하시겠습니까? 1.과자 2.빵 3.과일 4.생선 5.술");
            ...
            if (Count == 4) {
                while (true) {
                    ...
                    if (Deft[i][Paybackpeoplechoice] >= 1) {
            ...
            if (Count == 6) {
                ...
                int Controlchoice = sc.nextInt() - 2;
                System.out.println("i값 : "+i+" con 값 : "+Controlchoice+"");
                i = Controlchoice;
            }
        }
