...
public class LibraryBookFindWay implements BookFindWayInterface {
    ...
    @Override
    public void selectLookup(HashMap<LibraryManagement, Integer> bookList) {
        setFindCheck(false);
        while (true) {
            ...
            if (menuChoice == 1) {
                ...
                System.out.println("=========================================");
                for (LibraryManagement outputBook : bookList.keySet()) {
    ...
    public void findBookName (HashMap<LibraryManagement, Integer> bookList) {
