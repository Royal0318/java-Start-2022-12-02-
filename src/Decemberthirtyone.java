...
public class Decemberthirtyone {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < People; i++) {
            ...
            if (Select < 1 || Select > 9) {
             ...
             if (Select == 8) { ///////제어시스템 제어시스템을 할경우 특정손님으로 가야하니까 i를 컨트롤하자
                     System.out.println("몇번째 손님을 제어하시겠습니까?");
                     int Control = sc.nextInt(); //i값이 몇번째손님을 제어할것인지에 덮어져야함
                     System.out.println("\n1.과자  \n2.빵  \n3.과일  \n4.음료수  \n5.생선  \n6.다음 손님  \n7.종료버튼 \n8.제어  \n9.이전 손님으로 돌아가기");
            }
            //제어시스템구축,돈을 빌린사람이누구인지 기억하는 시스템구축
            if (Select == 1) { /////////과자
            ...
            if (Select == 6) {
                ...
                if (SnackCount != 0 || FishCount != 0 || FruitCount != 0 || BreadCount != 0 || DrinkCount != 0) { //1개이상 산경우 모두 초기화되서 다음사람을 넘어감
