...
당신은 프리랜서입니다 은행에서 근무하는 한 은행원이 은행프로그램을 간단하게 만들어 달라는 요청이 왔습니다
...
단, 처음에 2번과 3번을 입력할 시 [처음에는 계좌 조회만 가능합니다.]라는 문구가 나타나게 하고 계속 진입시 기회가 차감되도록 해주세요
...
주의조건) 현문제에서 반복문은 단 2번만 사용가능하며 최대한 코드를 간결하게 작성 해주세요
for문,while문 모두사용 가능하며 반복문과 if문 외에는 사용이 불가능합니다
 */
import java.util.Scanner;
public class Decembertwentieth {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (count == 3) {
                ...
                if (PersonalNumber < 100000) { //6자리 안되서 기회1번 더
                    Chance -= 1;
                    if (Chance >= 1) {
                ...
                if (PersonalNumber > 999999) { //6자리 넘어서 기회2번더
                    Chance -= 1;
                    if (Chance >= 1) {
                        System.out.println("주민등록번호를 다시 입력해주세요 남은기회 : " + (Chance + 2) + "회");
                    } else if (Chance == 0) {
                        System.out.println("\n주민등록번호를 다시 입력해주세요 남은기회 : " + (Chance + 2) + "회");
                    } else if (Chance == -1) {
                        System.out.println("\n마지막 기회입니다");
                    } else {
                        System.out.println("제한 횟수 초과!");
                ...
                if (PersonalNumber >= 100000 && PersonalNumber <= 999999) {
                    System.out.println("카드 비밀번호 4자리를 입력하세요");
                    int CardNumber = sc.nextInt();

                    if (CardNumber < 1000 || CardNumber > 9999) {
                        Chance -= 1;
                        if (Chance >= 1) {
                            System.out.println("카드 비밀번호를 다시 입력해주세요 남은기회 : " + Chance + "회");
                        } else if (Chance == 0) {
                            System.out.println("제한 횟수 초과!");
                            return;
                        }
        ...
        while (true) {
            ...
            if (count2 != 0) {
                if (Select == 1) {
                    Chance -= 1;
                    if (Chance >= 1) {
                        System.out.println("계좌 조회는 1회만 가능합니다 남은기회 " + Chance + "회");
                    } else {
                        System.out.println("제한 횟수 초과!");
                        return;
                    }
                ...
                if (Select == 2) {
                    ...
                    balance += Deposit;
                    System.out.println("입금을 " + Deposit + "원하여 총 잔액은 " + balance + "원 입니다");
                }
                if (Select == 3) {
                    ...
                    if (balance < Withdraw) {
                        ...
                        System.out.println("출금을 " + Withdraw + "원하여 총 잔액은 " + balance + "원 입니다");
                    }
                }
            }
            if (count2 == 0) {
                if (Select == 1) {
                    ...
                    if (Chance >= 1) {
                        Chance -= 1;
                        System.out.println("처음에는 계좌 조회만 가능합니다 남은기회 " + Chance + "회");
                    } else {
                        System.out.println("제한 횟수 초과!");
                        return;
                    }
