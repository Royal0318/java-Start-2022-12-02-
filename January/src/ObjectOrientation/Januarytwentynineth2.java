...
public class Januarytwentynineth2 {
    ...
    void Game2ListExplanation () {
        ...
        String Game2Select4 () {
            return "1.두 참가자가 제한시간 5분이네에 필드에 주어진 보스를 공격한다 \n2.제한시간동안 보스를잡거나 데미지를 더 많이 입힌 플레이어가 승리!";
        }
        String Game2Select5 () {
            return "게임 제작자 : 도현우";
        }
    ...
    String Game3Select4 () {
        return "1.두 참가자가 제한시간 1분이네에 상대의 체력을 모두 깎아 쓰러트리는 플레이어가 승리합니다 \n2.스킬사용이 자유로우며 숨겨진 스킬을 찾아서 상대방을 쓰려트려보세요!";
    }
    String Game3Select5 () {
        return "게임 제작자 : 김현준";
    }
    ...
    String Game4Select4 () {
        return "1.두 참가자는 제한시간 없이 필드에 주어진 트랙을 먼저 완주하는 플레이어가 승리하는 구조입니다 \n2.역주행은 할 수 없으며 드리프트를 사용하여 부스트를 사용하기위한 게이지를 모을 수 있습니다";
    }
    String Game4Select5 () {
    ...
    String Game5Select4 () {
        return "1.5:5참가자가 참가하여 제한시간이 없는 필드로 이동합니다 \n2.필드에 주어진 필드몬스터를 사냥해서 골드를 흭득하거나 상대방을 쓰러트려 레벨업과 아이템을 구매 할 수 있습니다 \n3.각각의 장비를 맞추고 상대방을 쓰러트려 상대 기지의 포탑을 모두 제거 후 본체를 먼저 파괴하는 팀이 승리합니다";
    }
    String Game5Select5 () {
