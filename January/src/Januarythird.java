                ...
                for (int k = PeopleSelect; k <= PeopleSelect; k++) { //한사람에게 값음
                    if (i == 0) { //0번째 손님
                        if (BorrowArr0[k] > 0) {
                            ...
                            arr[PeopleSelect] += PayBackMoney; //0번째 손님이 arr[PeopleSelect]번째 손님에게 돈을 갚았으니까 +=
                        ...
                        for (int j = i; j < 15; j++) {
                            ...
                            for (int k = j; k <= j; k++) {
                                if ((j - NumFixCount) == 0) {
                                    ...
                                    DebtSum[0] += Borrow; //빌린사람의 빚을 모두 합산하는 변수
                                } else if ((j - NumFixCount) == 1) {
